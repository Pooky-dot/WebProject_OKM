            ...
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="${pageContext.request.contextPath}/board/qnaboard.do">Q&A게시판</a>
  ...
  <div class="content_section container">
    ...
    <form name="writeFrm" method="post" action="../board/freeboardwrite.do" onsubmit="return validateForm(this);">
      <table class="form_table">
        ...
        <tr>
          <th>내용</th>
          <td><textarea name="content" style="width:90%;height:150px;"></textarea></td>
        </tr>
      </table>
      <div class="bottom-menu">
        <button type="submit">작성 완료</button>
        <button type="reset">RESET</button>
        <button type="button" onclick="location.href='../board/freeboard.do';">목록 바로가기</button>
      </div>
    </form>
  </div>
